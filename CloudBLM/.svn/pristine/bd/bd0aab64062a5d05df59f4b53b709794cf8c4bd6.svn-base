  ...
  node('master'){
    // Run the job in master jenkins
      stage('playbook-checkout')
      {
          ...
          cleanWs() 
checkout([$class: 'SubversionSCM', additionalCredentials: [], excludedCommitMessages: '', excludedRegions: '', excludedRevprop: '', excludedUsers: '', filterChangelog: false, ignoreDirPropChanges: false, includedRegions: '', locations: [[cancelProcessOnExternalsFail: true, credentialsId: '585fa701-720a-4602-abe6-b977c8773a4c', depthOption: 'infinity', ignoreExternalsOption: true, local: '.', remote: 'https://192.168.1.200/svn/CloudBLM-DevOps/deployment/windows-playbook/UAT-Ansible/AssetManagement']], quietOperation: true, workspaceUpdater: [$class: 'UpdateUpdater']])      
}
      stage('Stop IIS website')
      {
          // Stop the IIS service via ansible
          sh 'ansible-playbook AssetManagement-stop.yml'
      }
  }
}
...

{
  //Remove the object file 
               ...
               bat 'del /Q CloudBLM-AssetManagementService\\obj'
               bat 'del /Q CloudBLM-Asset-Models\\obj'
               bat 'del /Q CloudBLM-AssetService-BL\\obj'
               bat 'del /Q CloudBLM-AssetService-DL\\obj' 
               bat 'del /Q CloudBLM-AssetService-IBL\\obj' 
               bat 'del /Q CloudBLM-AssetService-IDL\\obj'
...
stage('publish')
{
  //publish and delete the working dir in jenkins
   bat 'dotnet publish CloudBLM-AssetManagementService.sln -c Release -o D:\\CloudBLM_UAT\\AssetManagement'
   deleteDir()
}
...
checkout([$class: 'SubversionSCM', additionalCredentials: [], excludedCommitMessages: '', excludedRegions: '', excludedRevprop: '', excludedUsers: '', filterChangelog: false, ignoreDirPropChanges: false, includedRegions: '', locations: [[cancelProcessOnExternalsFail: true, credentialsId: '585fa701-720a-4602-abe6-b977c8773a4c', depthOption: 'infinity', ignoreExternalsOption: true, local: '.', remote: 'https://192.168.1.200/svn/CloudBLM-DevOps/deployment/windows-playbook/UAT-Ansible/AssetManagement']], quietOperation: true, workspaceUpdater: [$class: 'UpdateUpdater']])    
      ...
      stage('Start IIS website')
      {
        ...
        sh 'ansible-playbook AssetManagement-start.yml'
         deleteDir()
      }
  }
}
