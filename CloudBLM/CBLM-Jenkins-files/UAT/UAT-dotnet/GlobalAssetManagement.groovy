...
stage('Remove obj')
{
  //Remove the object file 
              ...
              bat 'del /Q CloudBLM-DatabaseEntities\\obj'
               bat 'del /Q CloudBLM-GlobalAsset-BL\\obj'
               bat 'del /Q CloudBLM-GlobalAsset-DL\\obj'
               bat 'del /Q CloudBLM-GlobalAsset-IBL\\obj'
               bat 'del /Q CloudBLM-GlobalAsset-IDL\\obj'
               bat 'del /Q CloudBLM-GlobalAsset-Models\\obj'
               bat 'del /Q GlobalAssetManagement\\obj'
}
stage('clean')
{
    bat 'dotnet clean'
...
stage('publish')
{
  //publish and delete the working dir in jenkins
   bat 'dotnet publish GlobalAssetManagement.sln -c Release -o D:\\CloudBLM_UAT\\GlobalAsset'
   deleteDir()
}
...
checkout([$class: 'SubversionSCM', additionalCredentials: [], excludedCommitMessages: '', excludedRegions: '', excludedRevprop: '', excludedUsers: '', filterChangelog: false, ignoreDirPropChanges: false, includedRegions: '', locations: [[cancelProcessOnExternalsFail: true, credentialsId: '585fa701-720a-4602-abe6-b977c8773a4c', depthOption: 'infinity', ignoreExternalsOption: true, local: '.', remote: 'https://192.168.1.200/svn/CloudBLM-DevOps/deployment/windows-playbook/UAT-Ansible/GlobalAssetManagement']], quietOperation: true, workspaceUpdater: [$class: 'UpdateUpdater']])      
      ...
      stage('Start IIS website')
      {
        ...
        sh 'ansible-playbook GlobalAssetManagement-start.yml'
         deleteDir()
      }
  }
}
